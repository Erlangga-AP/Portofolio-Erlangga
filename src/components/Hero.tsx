      ...
      <div className="flex flex-col items-center justify-between gap-12 px-[150px] pt-4 lg:flex-row">
        <div className="w-fit rounded-br-[150px] rounded-tl-[150px] border border-white p-8 text-sm font-medium text-white shadow-[-5px_-5px_3px_#12F7D6]">
          <div className="mb-[32px] flex flex-col items-center">
            <div
              className="h-20 w-20 overflow-hidden rounded-full border-[4px] border-Brand1"
              aria-hidden="true"
            >
              <img src="/angga.avif" alt="" />
            </div>
          ...
          <div className="grid gap-3 font-IBMPlexMono">
            ...
            <div className="flex gap-4 text-center">
              <img src="/location-color-logo.svg" alt="" aria-hidden="true" />
              <span>Jakarta</span>
            </div>
            <div className="flex gap-4 text-center">
              <img src="/briefcase-color-logo.svg" alt="" aria-hidden="true" />
              <span>Full-time / Freelance</span>
            </div>
            <div className="flex gap-4 text-center">
              <img src="/linked-color-logo.svg" alt="" aria-hidden="true" />
              <span>www.erlangga.com</span>
            </div>
          </div>
          <div className="mb-[32px] mt-4 flex gap-2">
            <span
              className="rounded-xl border-white bg-Brand2 px-2 text-BG1"
              aria-hidden="true"
            >
              HTML
            </span>
          ...
          <button className="flex gap-4 rounded-full bg-white px-[32px] py-[16px] text-BG2">
            Download CV{" "}
            <img src="/download-logo.svg" alt="" aria-hidden="true" />
          </button>
        </div>
        ...
        <div className="text-[45px] text-white">
          ...
          <div className="mx-auto mt-6 max-w-2xl">
            <h2>
              ...
              <img src="/p-closed-color-logo.svg" alt="" aria-hidden="true" />
            </h2>
          </div>
          <div className="mt-4 flex items-center gap-4 text-[32px] text-Brand1">
            <span>Let's Talk</span>
            <div
              className="flex h-10 w-10 items-center justify-center rounded-full bg-Grey"
              aria-hidden="true"
            >
